...
function EVCostTracker() {
    ...
    const [newCharge, setNewCharge] = React.useState({
        date: new Date().toISOString().slice(0, 16),  // CORRETTO: era stringa vuota
        totalKm: "",
        kWhAdded: "",
        supplier: "",
        cost: ""
    ...
    // SPOSTATO QUI (dopo le dichiarazioni di stato)
    ...
    function saveSettings() {
        // già gestito da useEffect, ma diamo feedback all'utente
        alert("✅ Impostazioni salvate automaticamente!");
    }
    ...
    async function handleSaveCharge() {
        ...
        if (!newCharge.totalKm || !newCharge.kWhAdded || !newCharge.supplier) {
            alert("⚠️ Compila tutti i campi obbligatori (Km, kWh, Fornitore)");
            return;
        }
        
        if (!newCharge.date) {
            alert("⚠️ Seleziona data e ora");
            return;
        }
        ...
        if (ok) {
            ...
            setNewCharge({
                date: new Date().toISOString().slice(0, 16),  // RESET con data corrente
                totalKm: "",
                kWhAdded: "",
                supplier: "",
                cost: ""
                    ...
                    <div className="animate-fade-in space-y-10">
                        ...
                        {chartOptions.showCost && (
                            <div className="chart-card">
                                ...
                                <CostChart charges={charges} theme={settings.theme} />
                            </div>
                        )}
                        ...
                        {chartOptions.showKwh && (
                            <div className="chart-card">
                                ...
                                <KwhChart charges={charges} theme={settings.theme} />
                            </div>
                        )}
                        ...
                        {chartOptions.showConsumption && (
                            <div className="chart-card">
                                ...
                                <ConsumptionChart charges={charges} theme={settings.theme} />
                            </div>
                        )}
                        ...
                        {chartOptions.showEurKwh && (
                            <div className="chart-card">
                                ...
                                <EurKwhChart charges={charges} theme={settings.theme} />
                            </div>
                        )}
                        ...
                        {chartOptions.showEur100km && (
                            <div className="chart-card">
                                ...
                                <Eur100Chart charges={charges} theme={settings.theme} />
                            </div>
                        )}
                    </div>
                )}
